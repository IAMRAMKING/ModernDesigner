...
namespace ModernDesigner.Serialization
{
    public class DefaultDesignerLoader : Component, IDesignerLoader, IDesignerSerializationService
    {
        ...
        [DefaultValue(LoadModes.Default), Description("Get or set the loading mode of the designer")]
        public LoadModes LoadMode { get; set; } = LoadModes.Default;

        [DefaultValue(false), Description("Enable or disable the display error message box")]
        ...
        #region IDesignerLoader Interface member
...
#pragma warning disable CS0168 // Variable is declared but never used
            ...
            catch (Exception ex)
            {
                if (this.ShowErrorMessage)
                {
                    MessageBox.Show($"Assembly {assemblyName} Creation type {type} fail");
                }
            }
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        private object CreateObject(string typeName, string objName, bool createComponent)
        {
            ...
            if (obj == null)
            {
                ...
                {
                    string error = $"Creation type {type} fail，{ex.Message}";
                    if (this.ShowErrorMessage)
                    {
        ...
        private object GetOrCreateObject(Control parent, IReader reader, ref bool finded)
        {
            ...
            finded = false;
            // Allow repeat，Create a new object directly and return
            ...
            //  Find the object，Return directly。
            if (obj != null)
            {
                finded = true;
                return obj;
            ...
            // in the case of ModifyExisting and type no IComponent Create object
        ...
        /// <summary>
        /// when this.LoadMode == LoadModes.EraseForm Clear form component
        /// </summary>
