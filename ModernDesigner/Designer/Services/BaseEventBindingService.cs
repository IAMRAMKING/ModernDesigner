...
namespace ModernDesigner.Services
{
    public class BaseEventBindingService : IEventBindingService
    {
        ...
        #region IEventBindingService Interface member
        ...
        private class EventPropertyDescriptor : PropertyDescriptor
        {
            ...
            public override void SetValue(object component, object value)
            {
                ...
                if (this.IsReadOnly)
                {
                    throw new InvalidOperationException("Try to set up only events。");
                }
                if (value != null && !(value is string))
                {
                    throw new ArgumentException($"Can't set value{value}。");
                }
            ...
            private ISite GetCompoentSite(object component)
            {
                ...
                if (site == null)
                {
                    throw new InvalidOperationException($"Component {component} no setting Site Attributes");
                }
                return site;
            }
            ...
            private IDictionaryService GetDictionaryService(ISite site)
            {
                ...
                throw new InvalidOperationException("could not find it IDictionaryService。");
            }
