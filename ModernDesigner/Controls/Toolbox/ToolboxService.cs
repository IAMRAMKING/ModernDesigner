...
{
    /// <summary>
    /// Provide the method and attributes of managing and querying toolboxes in the design mode。
    /// </summary>
    public class ToolboxService : AbstractService, IToolboxService
    {
        ...
        #region IToolboxService  Interface attribute member
        ...
        #region IToolboxService  Interface Method Member
